...
| Образовательная платформа | Название курса | Ссылка на сертификат курса или файл | Месяц и год окончания | Полученные навыки |
| -------- | -------- | -------- |  -------- |  -------- |
| [stepik](https://stepik.org/course/52483/promo) | Информационные технологии. Работа с электронными таблицами Excel | сертификат | 24/25 | Формулы, функции, массивы. Визуализация, диаграмма, спарклайны, 3D-карты. Анализ данных, свобные таблицы. Сценарии, праметры, оптимизации. |
